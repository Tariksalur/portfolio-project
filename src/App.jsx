            ...
            <div className="col-md-7">
              <div className="card p-3 py-4">
                ...
                <div className="flex justify-center w-[100vw]">
                  <img
                    className="h-64  mt-16 border-solid border-sky-500 rounded-md border-4"
                    src={Elonimage}
                    alt="elon.jpg"
                  />
                </div>
                ...
                <div className="">
                  <div className="flex justify-center w-[100vw] mt-32 ">
                    <span className="bg-sky-500 p-1 px-32 rounded text-white">
                      PROFİLE
                    </span>
                    <h5 className="mt-32 mb-0">Elon Musk</h5>

                    <h1 className="mt-32">COMPANIES</h1>
                  </div>
                  <MySlider />
                  <div>
                    <div className="content">
                      <div>
                        <span className="mt-32">Companies</span>
                      ...
                      <div>
                        <p className="text">
                          ...
                          kardeşi Kimbal Musk’la beraber yeni organizasyonlar
                          için bir çevrim içi içerik yayımlama yazılımı olan
                          Zip2 projesine başlamak için okulu bıraktı.i 1999’da,
                        ...
                        <p className="text">
                          ...
                          finans ve ödeme servisi olan X.com’un ortak
                          kuruculuğunu yaptı. Ertesi yıl X.com bir 50/50
                          birleşme anlaşmasıyla X.com ile aynı büyüklükte bir
                          açık artırma sistemi olan Confinity’yi bünyesine
                          katarak PayPal’ı oluşturdu.
                          <a
                            className="link-tesla"
                            href="https://www.spacex.com/"
                            target="_blank"
                          ...
                          SpaceX Musk, eski ABD başkanı Barack Obama ile Falcon
                          9 fırlatma tesisinde, 2010 Musk, üçüncü şirketi Space
                          ...
                          pazarını hedefleyen üçüncü ürünü Model X 9 Şubat
                          2012’de duyurdu. Model X’in üretimine 2014’te
                          başlanması planlanıyor. Kendi araçlarına ek olarak
                          Tesla, Daimler’e Smart EV ve Mercedes A serisi ve
                          Toyota’ya gelecekte çıkaracağı RAV4 için elektrik
                          motorları ve güç aktarım organları satmaktadır. Ayrıca
                          Musk, bu iki şirketi de Tesla’ya uzun vadeli yatırımcı
                          olarak kazandırmayı başarmıştır.
                          <a
                            className="link-tesla"
                            href="https://www.boringcompany.com/"
                            target="_blank"
                          ...
                          araştırmalarını halka açık hale getirerek diğer kurum
                          ve araştırmacılarla “serbest iş birliği yapmayı”
